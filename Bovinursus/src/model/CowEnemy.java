...
public class CowEnemy implements MovableObject {
	private int xPos;
	private int yPos;
	...
	private int collisionX = Config.cCowCDCentreX;
	private int collisionY = Config.cCowCDCentreY;
	private int collisionRadius = Config.cCowCollisionRadius;
	
	public CowEnemy(int xPos, int yPos, MotionPath path) {
		this.xPos = xPos;
		this.yPos = yPos;
